                                        ...
                                        <tbody>
                                            @foreach ($file as $key => $files)
                                                <tr>
                                                    <td></td>
                                                    <td> {{$key+1}} </td>
                                                    <td> <img src="{{asset('storage/images/slider/' .$files->image)}}" class="img-responsive" style="max-width: 50px; max-height:50px"> </td>
                                                    <td> {{$files->is_active == '0' ? 'Aktif' : 'Tidak Aktif'}} </td>
                                                    <td>
                                                        <a href=" {{route('backend-imageslider.edit', $files->id)}} " class="btn btn-success btn-sm">Edit</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>                                   
